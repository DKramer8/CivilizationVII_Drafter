...
const i18n = {
    en: {
        ...
        randomTooltip: "Determines which civilization/leader combinations can be drafted based on selected matching rules. These rules differ from ingame prefered combinations. <br><br><b>Random:</b> No pairing restrictions.<br><b>Historic:</b> Leaders that are historically tied to the civilization. Some civilizations have no assigned leaders.<br><b>Geographic:</b> Leaders associated with roughly the same region as the civilization. Some civilizations have no assigned leaders. Leaders can be linked to many civilizations (none to all).<br><b>Strategic:</b> Leaders that fit the civilization strategically. Leaders can be linked to many civilizations (none to all).",
        modeRandom: "Random",
    ...
    de: {
        ...
        randomTooltip: "Beeinflusst den Auswahlpool der Zivilisationen und Anführer*innen basierend auf deren Kombinationsmöglichkeiten. <br><br><b>Zufällig:</b> Ohne Einschränkungen.<br><b>Historisch:</b> Anführer*innen, die nachweislich Teil der Zivilisation waren. Manche Zivilisationen haben keine Anführer*innen zugeordnet.<br><b>Geografisch:</b> Anführer*innen, die vermutlich einmal am selben geografischen Ort gewirkt haben, an dem sich die Zivilisation befindet. Manche Zivilisationen haben keine Anführer*innen zugeordnet. Anführer*innen koennen verschieden vielen Zivilisationen zugeordnet sein (keine bis alle).<br><b>Strategisch:</b> Anführer*innen, die spielstrategisch zur Zivilisation passen. Anführer*innen koennen verschieden vielen Zivilisationen zugeordnet sein (keine bis alle).",
        modeRandom: "Zufällig",
